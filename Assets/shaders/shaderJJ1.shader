...
Shader "Custom/shaderJJ1"
{
	Properties
	{
		_LineColor("LineColor", Color) = (0,0,1,1)
	...
	SubShader
	{
		...
		Pass
		{
			...
			void geom(triangle v2g i[3], inout TriangleStream<g2f> triangleStream)
			{
				...
				//do a little twist on the vertex, based on the time...
				float a, b, c;
				a = _Time % 1;
				b = _Time % 1;
				c = _Time % 1;
				...
				o.projectionSpaceVertex = i[0].projectionSpaceVertex + rand(float3(a, b, c));
				...
				o.projectionSpaceVertex = i[1].projectionSpaceVertex + rand(float3(a, b, c));
				...
				o.projectionSpaceVertex = i[2].projectionSpaceVertex + rand(float3(a, b, c));
